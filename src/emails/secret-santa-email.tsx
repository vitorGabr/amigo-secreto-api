    ...
    <Tailwind>
      <Section className="bg-gray-100 font-sans">
        <Section className="max-w-2xl mx-auto bg-white rounded-lg shadow-md p-8">
          ...
          <Text className="mb-4">
            Você tirou o nome de <Text className="font-bold">{giftee}</Text> no nosso amigo secreto! Prepare um presente especial para tornar este evento ainda mais memorável.
          </Text>
          <Text className="mb-4">
